    ...
    public function search(Request $request)
{
    ...
    // cities.iso stores the country ISO-2 (e.g. DZ for Algeria) directly, so
    // the flag can be rendered without depending on the client-side hardcoded
    // country→ISO table (which was missing entries like Algeria).
    $cities = $cities->map(function($city) {
        ...
        return [
            ...
            'iso' => $city->iso ? strtoupper($city->iso) : null,
