                                            ...
                                            <tbody>
                                                ...
                                                <tr id="row{{$gender->id}}">
                                                    ...
                                                    <td><button type="button" key="{{$k}}" id="editthis" class="btn btn-info btn-sm">Edit</button> 
                                                    	<button type="button" key="{{$k}}" rid="{{$gender->id}}" id="updatethis" class="btn btn-success btn-sm">Update</button>

                                                    	<button onclick="return confirm('are you sure?')" type="button" id="del" key="{{$k}}" rid="{{$gender->id}}" class="btn btn-danger btn-sm">Delete</button>
