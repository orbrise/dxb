                    ...
                    <tbody>
                        ...
                        <tr id="row{{$bust->id}}">
                            ...
                            <td>
                                ...
                                <button type="button" key="{{$k}}" rid="{{$bust->id}}" id="updatethis" class="btn btn-success btn-sm">Update</button>
                                <button onclick="return confirm('Are you sure?')" type="button" id="del" key="{{$k}}" rid="{{$bust->id}}" class="btn btn-danger btn-sm">Delete</button>
