                    ...
                    <tbody>
                        ...
                        <tr id="row{{$hairColor->id}}">
                            ...
                            <td>
                                ...
                                <button type="button" key="{{$k}}" rid="{{$hairColor->id}}" id="updatethis" class="btn btn-success btn-sm">Update</button>
                                <button onclick="return confirm('Are you sure?')" type="button" id="del" key="{{$k}}" rid="{{$hairColor->id}}" class="btn btn-danger btn-sm">Delete</button>
