...
<div class="col-md-3 col-sm-6 widget-holder widget-full-height">
                        <div class="widget-bg bg-primary text-inverse">
                            ...
                            <a style="color:black; text-decoration:none" href="{{ route('admin.users') }}">
                                <div class="widget-counter">
                                    ...
                                    <h3 class="h1"><span class="counter">{{ $stats['total_users'] }}</span></h3><i class="material-icons list-icon">add_shopping_cart</i>
                                </div>
                                </a>
                                <!-- /.widget-counter -->
                            </div>
                        ...
                        <div class="widget-bg bg-color-scheme text-inverse">
                            ...
                            <a style="color:black; text-decoration:none" href="{{ route('admin.profiles.index') }}">
                                <div class="widget-counter">
                                    ...
                                    <h3 class="h1"><span class="counter">{{ $stats['total_profiles'] }}</span></h3><i class="material-icons list-icon">event_available</i>
                                </div>
                                </a>
                                <!-- /.widget-counter -->
                            </div>
    ...
    <div class="col-md-3 col-sm-6 widget-holder widget-full-height">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                             <a style="color:black" href="{{ url('admin/profiles?id=&start_date=&end_date=&title=&city=&status=1&premium=') }}">

                                <div class="widget-counter">
                                    <h6>Active Profiles <small></small></h6>
                                    <h3 class="h1"><span class="counter">{{ $stats['active_profiles'] }}</span></h3><i class="material-icons list-icon">public</i>
                                </div>
                                </a>
                                <!-- /.widget-counter -->
                            </div>
...
<div class="col-md-3 col-sm-6 widget-holder widget-full-height">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                             <a style="color:black" href="{{ url('admin/profiles?id=&start_date=&end_date=&title=&city=&status=0&premium=') }}">
                                <div class="widget-counter">
                                    <h6>Inactive Profiles <small></small></h6>
                                    <h3 class="h1"><span class="counter">{{ $stats['inactive_profiles'] }}</span></h3><i class="material-icons list-icon">show_chart</i>
                                </div>
                                </a>
                                <!-- /.widget-counter -->
                            </div>
...
<script>
    ...
    xaxis: {
        ...
        title: {
            text: 'Day-Month (DD-MM) - Last 30 Days'
        }
    },
    yaxis: {
        title: {
