<div style="background-color:#0D1011;font:14px/1.5 'Helvetica Neue',Helvetica,Arial,sans-serif;color:#fff">
    <div style="padding:20px;max-width:670px;background-color:#0D1011;font:14px/1.5 'Helvetica Neue',Helvetica,Arial,sans-serif;color:#fff">
        ...
        <h3 style="color:#fff;font-size:24px">
            <a href="{{ config('app.url') }}/{{ $genders[0] }}-escort-news-in-{{ strtolower(str_replace(' ', '-', $cityNames[0])) }}/new-escort-reviews?utm_campaign=Newsletter&utm_content=Weekly%20Update&utm_medium=email&utm_source=AppMail" style="color:#C1F11D;text-decoration:none;outline:0">
        ...
        <div style="font-style:italic;margin-bottom:20px;clear:both">
            @if($review->profile)
            <a href="{{ config('app.url') }}/{{ $review->profile->gender }}-escorts-in-{{ strtolower(str_replace(' ', '-', $review->profile->getcity->name ?? 'dubai')) }}/{{ $review->profile->slug }}?utm_campaign=Newsletter&utm_content=Weekly%20Update&utm_medium=email&utm_source=AppMail" style="color:#C1F11D;text-decoration:none;outline:0">
            ...
            <a href="{{ config('app.url') }}/{{ $review->profile->gender }}-escorts-in-{{ strtolower(str_replace(' ', '-', $review->profile->getcity->name ?? 'dubai')) }}/{{ $review->profile->slug }}?utm_campaign=Newsletter&utm_content=Weekly%20Update&utm_medium=email&utm_source=AppMail" style="color:#C1F11D;text-decoration:none;outline:0">More</a>
        ...
        <h3 style="color:#fff;font-size:24px">
            <a href="{{ config('app.url') }}/{{ $genders[0] }}-escort-news-in-{{ strtolower(str_replace(' ', '-', $cityNames[0])) }}/new-escorts?utm_campaign=Newsletter&utm_content=Weekly%20Update&utm_medium=email&utm_source=AppMail" style="color:#C1F11D;text-decoration:none;outline:0">
        ...
        @foreach($listings->take(15) as $listing)
            <li style="color:#fff;display:list-item;list-style-type:disc;line-height:21px;float:left;list-style:none;display:block;padding-left:0;width:157.5px;margin-left:10px">
                <a href="{{ config('app.url') }}/{{ $listing->gender }}-escorts-in-{{ strtolower(str_replace(' ', '-', $listing->getcity->name ?? 'dubai')) }}/{{ $listing->slug }}?utm_campaign=Newsletter&utm_content=Weekly%20Update&utm_medium=email&utm_source=AppMail" style="color:#C1F11D;text-decoration:none;outline:0">
        ...
        <h3 style="color:#fff;font-size:24px">
            <a href="{{ config('app.url') }}/{{ $genders[0] }}-escort-news-in-{{ strtolower(str_replace(' ', '-', $cityNames[0])) }}/new-questions?utm_campaign=Newsletter&utm_content=Weekly%20Update&utm_medium=email&utm_source=AppMail" style="color:#C1F11D;text-decoration:none;outline:0">
        ...
        <div style="margin-bottom:20px;clear:both">
            @if($question->profile)
            <a href="{{ config('app.url') }}/{{ $question->profile->gender }}-escorts-in-{{ strtolower(str_replace(' ', '-', $question->profile->getcity->name ?? 'dubai')) }}/{{ $question->profile->slug }}?utm_campaign=Newsletter&utm_content=Weekly%20Update&utm_medium=email&utm_source=AppMail" style="color:#C1F11D;text-decoration:none;outline:0">
                <span style="display:block;margin:0 auto;margin-right:10px;float:left">
                    <div>
