...
<head>
    ...
    <title>Verification Photo Received - evoory</title>
</head>
<body style="margin: 0; padding: 0; background-color: #0D1011; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">
    <div style="background-color: #0D1011; padding: 20px;">
        <div style="padding: 20px; max-width: 670px; margin: 0 auto; background-color: #0D1011; color: #ffffff;">
            ...
            <!-- Content -->
            <h1 style="font-size: 1.5em; margin-bottom: 1em; font-weight: 700; color: #ffffff;">Hi{{ $userName ? ' '.$userName : '' }},</h1>

            <p style="font-size: 14px; line-height: 1.5; color: #ffffff; margin-bottom: 15px;">
                Thanks for submitting a verification photo for your profile <strong>{{ $profileName }}</strong>. We've received it and our moderation team will review it shortly.
            </p>
            ...
            <div style="background-color: #131616; border: 2px solid #C1F11D; border-radius: 5px; padding: 20px; margin: 25px 0;">
                ...
                <p style="font-size: 18px; font-weight: bold; color: #C1F11D; margin: 0 0 10px 0;">Pending Review</p>
                <p style="font-size: 14px; color: #ffffff; margin: 0;">Profile: <strong style="color: #C1F11D;">{{ $profileName }}</strong></p>
            </div>

            <p style="font-size: 14px; line-height: 1.5; color: #ffffff; margin-bottom: 15px;">
                Review typically takes up to <strong>48 hours</strong>. We'll email you again once your photo has been approved (or if we need any additional information).
            </p>
            ...
            <ul style="font-size: 14px; color: #ffffff; padding-left: 20px; margin: 0 0 20px;">
                <li style="margin-bottom: 6px;">Our team checks the photo against the images on your listing.</li>
                <li style="margin-bottom: 6px;">Once approved, your profile gets a "Verified" badge and higher visibility in listings.</li>
                <li>Your uploaded verification photo is never published or shared publicly.</li>
            </ul>
            ...
            <p style="font-size: 10pt; line-height: 1.5; color: #bebebe; border-top: 2px solid #2a2a2a; margin-top: 20px; padding-top: 15px; text-align: justify;">
                You're receiving this email because you submitted a photo verification request on evoory.
                If you didn't submit this, or if you have any questions, please contact our support team at
