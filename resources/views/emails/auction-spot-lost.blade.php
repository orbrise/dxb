                ...
                <tbody>
                    <tr>
                        <td style="border-radius: 3px; background-color: #C1F11D; text-align: center;">
                            <a href="{{ $auctionsUrl }}" style="outline: 0; color: #000000; text-decoration: none; font-size: 20px; font-family: Arial, Helvetica, sans-serif; font-weight: bold; line-height: 20px; padding: 12px 30px; display: block; text-shadow: #FDE877 0px 1px 0px;">
