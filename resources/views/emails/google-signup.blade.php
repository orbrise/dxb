...
<body style="margin: 0; padding: 0; background-color: #0D1011; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">
    <div style="background-color: #0D1011; padding: 20px;">
        <div style="padding: 20px; max-width: 670px; margin: 0 auto; background-color: #0D1011; color: #ffffff;">
            ...
            <!-- Password Box -->
            <div style="background-color: #131616; border: 2px solid #C1F11D; border-radius: 5px; padding: 20px; margin: 25px 0; text-align: center;">
                <p style="font-size: 14px; color: #bebebe; margin: 0 0 10px 0;">Your password is:</p>
                <p style="font-size: 24px; font-weight: bold; color: #C1F11D; margin: 0; letter-spacing: 2px;">{{ $mailData['password'] }}</p>
            </div>
                ...
                <tbody>
                    <tr>
                        <td style="border-radius: 21.5px; background-color: #C1F11D; text-align: center;">
                            <a href="{{ url('/sign-in') }}" style="outline: 0; color: #000000; text-decoration: none; font-size: 14px; font-family: Arial, Helvetica, sans-serif; font-weight: 600; line-height: 20px; padding: 8px 22px; display: block;">
                                Login Now!
                            </a>
                        </td>
                    </tr>
            ...
            <p style="font-size: 10pt; line-height: 1.5; color: #bebebe; border-top: 2px solid #2a2a2a; margin-top: 20px; padding-top: 15px; text-align: justify;">
                You're receiving this email because you recently created a new account using Google Sign-In on evoory. 
