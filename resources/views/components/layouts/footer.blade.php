      ...
      <div class="footer-nav-links">
        <ul class="list-inline mb-3 d-flex flex-wrap align-items-start">
          ...
          <li class="mb-0" style="vertical-align:middle">
            <a class="d-inline-flex align-items-center py-0" href="https://trafficking.help/">
              <svg class="mr-1" id="a" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 35 47">
