<link href="{{smart_asset('assets/images/web/icon3.png')}}" rel="apple-touch-icon" />
    ...
    <!-- Critical CSS - Load all essential CSS synchronously to prevent white flash -->
    ...
    <!-- Font Awesome 5.15.3 - Load async to prevent render-blocking -->
    ...
    <style>
      /* CRITICAL: Force Font Awesome font with highest priority - override any conflicts from app3/app4 CSS */
      @font-face {
        font-family: "Font Awesome 5 Free" !important;
        font-style: normal;
        font-weight: 900;
        font-display: block !important;
        src: url('{{smart_asset("assets/fonts/fa-solid-900.woff2")}}') format("woff2") !important;
      }
      /* Ultra high specificity rules */
      i[class*="fa"], i.fa, i.fas, i.far, i.fab, i.fal,
      .fa, .fas, .far, .fab, .fal,
      ...
      /* Force all FA icons regardless of other CSS */
      *[class*="fa-"]:before {
        font-family: "Font Awesome 5 Free" !important;
        font-weight: 900 !important;
      }
    ...
    <style>
      ...
      *,
      ...
      .activity-records-mini li:before,
      .navbar-header:after,
      ...
      .mini span.verified-image:hover span {
        visibility: hidden
      }
      ...
      .mini span.verified-image {
        width: 20px;
        height: 20px;
        line-height: 20px
      }

      .mini span.verified-image i {
        line-height: 20px;
        font-size: 1.5em
      }

      .mini span.verified-image span {
        font-size: .85em
      }
      ...
      #main-nav a.selected:active:before,
      #main-nav a.selected:before,
      #main-nav a.selected:focus:before,
      #main-nav a.selected:hover:before {
        content: " ";
        height: 0;
        position: absolute;
        width: 0;
      ...
      .activity-records-mini .activity-row,
      .activity-records-mini p {
        margin: 0
      }
      ...
      @media (min-width:768px) {
        ...
        .activity-record.mini .img-wrapper.mini img,
        .listing-li .img-wrapper.mini img {
          width: 50px;
          height: 53px
        }
      ...
      .listing-li.featured>.thumbs>.other-thumbs>.thumb,
      .listing-li.premium>.thumbs>.other-thumbs>.thumb {
        margin-bottom: 15px
      }

      .listing-li.featured>.thumbs>.other-thumbs>.thumb:last-child,
      .listing-li.premium>.thumbs>.other-thumbs>.thumb:last-child {
        margin-bottom: 0
      }

      .listing-li .see-more>a {
        font-family: Helvetica, Arial, sans-serif;
        font-weight: 700
      }
      ...
      @media (min-width:568px) {
        ...
        .listing-li.basic .listing-info-wrapper,
        .listing-li.free .listing-info-wrapper {
          padding-left: 94px
        }
      }
      ...
      only screen and (min-resolution:2dppx) {
        ...
        .select2-search input,
        .select2-search-choice-close {
          background-image: url({{smart_asset('assets/images/web/pic3.png')}}}) !important;
      ...
      .listings-primary-search .action-group>.btn,
      ...
      form .btn-lg.btn-primary[data-btn-submit]::after {
        height: 22px
      }
...
<script>
    ...
    loadCSS('{{smart_asset("assets/css/app3.css")}}');
  ...
  <link rel="stylesheet" media="print" href="{{smart_asset('assets/css/app5.css')}}" data-turbolinks-track="reload" />
 
  <script src="{{asset('assets/js/app2.js')}}" data-turbolinks-track="reload"></script>