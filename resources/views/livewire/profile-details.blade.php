...
<style>
  ...
  /* iPad Mini / Tablet view - show sidebar photos */
  @media (min-width: 768px) and (max-width: 991px) {
    .pb-thumbnails.col-sm-3 {
      display: block !important;
    }
    ...
    /* Hide the mobile gallery on tablet since sidebar is visible */
    .visible-xs.pb-thumbnails {
      display: none !important;
    }
  }

  /* Mobile 4-column grid layout for details */
  ...
  .lead.phone-number a:hover,
  .lead.phone-number a:focus,
  .lead.phone-number a:active {
...
;
    ...
    top: -17px;
       ...
       .half-circle-button-vertical::before {
    content: '';
    width: 0;
    height: 0;
    border-style: solid;
...
.icon-telegram::before {
    background-image: url(https://mrassets.cc/assets/icons/telegram-823ab0b30ac8bf149a5a1f0de712b6026795fa5a5ca2ca79aa18ee02d9c53a3f.svg)
}

.icon-signal::before {
    background-image: url(https://mrassets.cc/assets/icons/signal-f7667b414b42429d038aa3def28963c689fc16ee490dacb3ab2ccbb65cde2f9e.svg)
}

.icon-whatsapp::before {
    background-image: url(https://mrassets.cc/assets/icons/whatsapp-7c70745f5ee9f066d5a9ab9595d0f24c19e36c020003bdc2981875ce9b681988.png)
}

.icon-wechat::before {
    background-image: url(https://mrassets.cc/assets/icons/wechat-e812583da1b740372beac8db4e10f75511752567505d6d6e470665f2b4239190.svg)
}
...
.fa-escort::before {
    ...
    height: 18px;
    display: inline-block;
    background: url(https://mrassets.cc/assets/layout/icon-escort-97a52ad9f02f7685b528c1a95d91fc46a3d7cb08ba6b97cd2c572297a8073af1.png);
...
form .upgrade-amount-section .validation-error {
    margin: 0;
    border-radius: 4px
}
...
form.listing .video-link {
    display: inline-block;
    background: url(https://mrassets.cc/assets/videologos@2x-25eb3d26b8ce80cfe5107ba52ef6a9be8dfac7f4b1f6b9f694b1545fe1cfc95c.png) no-repeat;
...
.logo {
    ...
    width: 165px;
    height: 55px;
    background: url(https://mrassets.cc/assets/layout/logo-3e48185d81fa7334b0e86ee0587c02b6d7d9be1dcc424971186b2e828fbcd85c.png) 0 0 no-repeat
}
...
.logo-mr01 {
    ...
    width: 165px;
    height: 55px;
    background: url(https://mrassets.cc/assets/layout/logo-mr01-714c3d16b98f37e079b1d4b9db7661a361ebf43362c05dda74a26a32ba0a21e5.svg) 0 0 no-repeat
}
...
.register-graphic {
    ...
    width: 130px;
    height: 130px;
    background-image: url(https://mrassets.cc/assets/layout/register-graphic-9503e085809c0f76f331ded70bedc6faa76a80b802b259c11dd3e3aa852bb626.png);
...
.listings-spots .spot .card--forsale {
    background-image: url(https://mrassets.cc/assets/spot_empty-6bd30f6b596e493f063e568f05f13000a12f491070662d3d554bc048d0215979.jpg);
...
.listings-spots.listing-spots--minimal.listing-spots--bump {
    background-color: rgba(144,238,144,.3)
}

.listings-spots.listing-spots--minimal.listing-spots--bump .spot .auction-cover {
    position: relative;
...
.listings-spots.listing-spots--minimal.listing-spots--bump .activenow span {
    font-size: .8em
}

.listings-spots.listing-spots--minimal.listing-spots--bump .spot-id {
    color: #90ee90
}

.listings-spots.listing-spots--minimal.listing-spots--bump .btn,.upgrade-duration__radios span {
    font-size: 1rem
}
...
.listings-bump .listing-li {
    background: rgba(144,238,144,.1);
    padding-inline:1rem}

.listings-bump .listing-li:not(:first-child) {
    padding-top: 20px
}

.listings-bump .listing-li:last-child {
    border: 0
}

.listings-bump .listing-li h2 {
    margin-top: .5rem
}

.listings-bump .listing-li::before {
    content: "active now";
    left: 50%;
    -webkit-transform: translateX(-50%);
    transform: translateX(-50%);
...
.listings-bump .listing-li::after {
    content: '';
...
.listings-bump .listing-li::after,.listings-bump .listing-li::before {
    position: absolute;
    top: .5rem;
    z-index: 1;
    text-transform: uppercase;
...
.upgrade-type .tick {
    ...
    margin-left: -20px;
    display: inline-block;
    background: url(https://mrassets.cc/assets/tick25-32c234d321d34debb7a7140c7fe718e5a00fe7b8cb109e6adf0613d4eae18ae8.png) no-repeat 0 0;
    margin-bottom: -6px;
    margin-right: 2px
}
...
.upgrade-type .current-text {
    ...
    margin-left: -100px;
    height: 30px;
    background: #474747 url(https://mrassets.cc/assets/tick25-32c234d321d34debb7a7140c7fe718e5a00fe7b8cb109e6adf0613d4eae18ae8.png) no-repeat 10px 3px
}
...
.upgrade-type.active:hover,.upgrade-type:has(input:checked) {
...
.payment-options li:has(input.payment-option-input:checked) {
...
.payment-options li:not(:has(input.payment-option-input:checked)):hover {
    background-color: rgba(0,0,0,.25);
    -webkit-transition: background-color .1s ease-in;
    transition: background-color .1s ease-in
}

.payment-options:not(.payment-options--basic) li {
    border: 2px solid rgba(255,255,255,.2);
    border-radius: 10px;
    -webkit-transition: border-color .25s ease,-webkit-transform .25s ease,-webkit-box-shadow .25s ease;
...
.payment-options:not(.payment-options--basic) .cc-inputs-wrap {
    background-color: rgba(0,0,0,.25)
}
...
.payment-options label .payment-option-title,.payment-options label>span {
    font-size: 1.3em
}
...
.payment-options label span.credit-cards-graphic,.payment-options span.credit-cards-graphic {
    background: url(https://mrassets.cc/assets/layout/card-logos-ffca42852ca3601abe8d921071783870c2d4103af6f5fca28d8dfcf71ec6540e.svg) no-repeat;
...
.payment-options label span.bitcoin-logo {
    background: url(https://mrassets.cc/assets/layout/bitcoin-7591e1fbbdc88fa974ae9b6c02b9c2a01c919997cfee11ad0fc8649792777c6f.svg) no-repeat;
    background-size: contain;
    margin-left: 10px;
    min-width: 43px;
    height: 43px
...
.payment-options label span.neosurf-logo {
    background: url(https://mrassets.cc/assets/layout/neosurf-bd53910fca644afad7f8660597f25b84b5c97418652d1c2794ab5f1462e2faf7.svg) no-repeat;
    background-size: contain;
    width: 70px;
    height: 19px
}
...
.payment-options label span.paysafe-logo {
    background: url(https://mrassets.cc/assets/layout/logo-paysafe-5eb996a71da24e6b5170d52a8c359e14009e00bb87d46a7afd049b010f7f61d8.svg) no-repeat;
    background-size: contain;
    margin-left: 10px;
    margin-top: 4px;
    min-width: 80px;
...
.animate-visible,[data-submit-url] {
...
.my-profile .listing-li .activenow {
    display: none
}
...
.my-profile-disapprove aside {
    border-top: 1px solid rgba(255,255,255,.1);
    min-width: 250px
}

.my-profile-disapprove aside .reason:empty {
    display: none
}

.my-profile-disapprove aside:has(.reason:empty) {
...
.my-profile-disapprove .btn-danger {
    background: #eb633b
}

.my-profile-disapprove .btn-danger:hover {
    background: #bb4623
}

.my-profile-disapprove .badge-danger {
    background: #eb633b!important
}
...
.cam-tutorial .model-intro {
    background-image: url(https://mrassets.cc/assets/partner/model_bckgr-ad21c48f9a59510090c55ae934f662cfec68cfce50634d3ec6dc395c82cb2562.jpg);
...
.cam-tutorial .block--disclaimer {
    background: -webkit-gradient(linear,left top,left bottom,from(#f4b827),to(#d3980b));
    background: linear-gradient(#f4b827,#d3980b);
    color: #000
}
...
.container--spot-confirm .block-confirm--bump {
    min-width: 330px
}
...
.fs {
    background-image: url(https://mrassets.cc/assets/layout/small-flags-e341f289fb39011a456b1efbeaf0248b59e82b6b9cab11ca9100dcb5e944c5ef.png);
    display: inline-block;
    height: 11px;
    width: 16px;
    vertical-align: baseline;
...
.select2-container .select2-choice abbr {
    ...
    text-decoration: none;
    border: 0;
    background: url(https://mrassets.cc/assets/select2/select2-8dbd849db3252358fd08db3cc9251185373125f6a045d6a33293c24b8de57dee.png) top right no-repeat;
    cursor: pointer;
    outline: 0
}
...
.select2-container .select2-choice .select2-arrow b {
    ...
    width: 100%;
    height: 100%;
    background: url(https://mrassets.cc/assets/select2/select2-8dbd849db3252358fd08db3cc9251185373125f6a045d6a33293c24b8de57dee.png) no-repeat 0 1px
}
...
.select2-search input {
    ...
    box-shadow: none;
    background-color: #fff;
    background: url(https://mrassets.cc/assets/select2/select2-8dbd849db3252358fd08db3cc9251185373125f6a045d6a33293c24b8de57dee.png) no-repeat 100% -22px,-webkit-gradient(linear,left top,left bottom,color-stop(85%,#fff),color-stop(99%,#eee)) 0 0;
    background: url(https://mrassets.cc/assets/select2/select2-8dbd849db3252358fd08db3cc9251185373125f6a045d6a33293c24b8de57dee.png) no-repeat 100% -22px,linear-gradient(to bottom,#fff 85%,#eee 99%) 0 0
}

html[dir=rtl] .select2-search input {
    padding: 4px 5px 4px 20px;
    background-color: #fff;
    background: url(https://mrassets.cc/assets/select2/select2-8dbd849db3252358fd08db3cc9251185373125f6a045d6a33293c24b8de57dee.png) no-repeat -37px -22px,-webkit-gradient(linear,left top,left bottom,color-stop(85%,#fff),color-stop(99%,#eee)) 0 0;
    background: url(https://mrassets.cc/assets/select2/select2-8dbd849db3252358fd08db3cc9251185373125f6a045d6a33293c24b8de57dee.png) no-repeat -37px -22px,linear-gradient(to bottom,#fff 85%,#eee 99%) 0 0
}
...
.select2-search input.select2-active {
    background-color: #fff;
    background: url(https://mrassets.cc/assets/select2/select2-spinner-6cb611191daa90427429b7b2ec192626115ef5d6edbaa94ee2b95234d8454728.gif) no-repeat 100%,-webkit-gradient(linear,left top,left bottom,color-stop(85%,#fff),color-stop(99%,#eee)) 0 0;
    background: url(https://mrassets.cc/assets/select2/select2-spinner-6cb611191daa90427429b7b2ec192626115ef5d6edbaa94ee2b95234d8454728.gif) no-repeat 100%,linear-gradient(to bottom,#fff 85%,#eee 99%) 0 0
}
...
.select2-more-results.select2-active {
    background: #f4f4f4 url(https://mrassets.cc/assets/select2/select2-spinner-6cb611191daa90427429b7b2ec192626115ef5d6edbaa94ee2b95234d8454728.gif) no-repeat 100%
}
...
.select2-container-multi .select2-choices .select2-search-field input.select2-active {
    background: #fff url(https://mrassets.cc/assets/select2/select2-spinner-6cb611191daa90427429b7b2ec192626115ef5d6edbaa94ee2b95234d8454728.gif) no-repeat 100%!important
}
...
.select2-search-choice-close {
    ...
    font-size: 1px;
    outline: 0;
    background: url(https://mrassets.cc/assets/select2/select2-8dbd849db3252358fd08db3cc9251185373125f6a045d6a33293c24b8de57dee.png) right top no-repeat
}
...
@media only screen and (-webkit-min-device-pixel-ratio: 2),only screen and (min-resolution:2dppx) {
    .select2-container .select2-choice .select2-arrow b,.select2-container .select2-choice abbr,.select2-search input,.select2-search-choice-close {
        background-image:url(https://mrassets.cc/assets/select2/select2x2-c0fb39605605e0646ac56e13cf7f6feb1f0eb50c19812ba720e0361bd7940ce7.png)!important;
...
.modal__lightning .modal-dialog .modal-content h4 {
    font-size: 1.5rem
}
...
.listings-search-advanced-fields .verified-label {
    background: -webkit-gradient(linear,left bottom,right top,from(#f4b827),to(#c3931f));
    background: linear-gradient(to top right,#f4b827,#c3931f);
    color: #333;
    font-weight: 700;
...
.custom-marker__bolt li::before {
    background-image: url(https://mrassets.cc/assets/icons/bolt-5e10a91a0ffc3bdeab1ed9ca70fc4ce0bbf680f648816db9d78316c97434c968.svg)
}
...
.modal-backdrop.in,.modal-header .close:hover {
    opacity: .8
}
...
.modal-content h2.modal-title .fa,.modal-content h3.modal-title .fa {
    color: #f6c655
}
...
#enhancementWarningModal .modal-body p {
    font-size: 16px
}

.modal .top-bleed-illustration {
    max-height: 350px;
    aspect-ratio: 1;
    -o-object-fit: cover;
    object-fit: cover;
...
.modal__lightning .modal-dialog {
    width: 800px;
    max-width: 100%
}

.modal__lightning .modal-dialog .modal-content,.panel-dark,table.table--borderless tr td {
    border: 0
}

.modal__lightning .modal-dialog .modal-content strong {
    color: #ffad02
}

.modal__lightning .modal-dialog .modal-content h4.modal-title {
    font-size: clamp(1.5rem,calc(1rem + 3vw),3rem)
}

.modal button.close.pale {
    right: 0;
    opacity: .4;
    color: #fff;
    text-shadow: none;
...
.modal__payment-result .modal-dialog {
    max-width: 500px
}

.modal__payment-result .modal-content {
    -webkit-box-shadow: none;
    box-shadow: none;
    border-radius: 10px
}

.modal__payment-result .modal-content .modal-body {
    font-size: 1rem
}

.modal__payment-result .status-illustration {
    --illy-size: 50px;
    --bcgr-rgb: 165, 165, 165;
    -webkit-box-sizing: content-box;
    box-sizing: content-box;
    position: relative;
    margin-top: calc(var(--illy-size)/-2);
    width: var(--illy-size);
    height: var(--illy-size);
    border-radius: 20rem;
    background-color: rgba(var(--bcgr-rgb),1);
    outline: 7px solid rgba(var(--bcgr-rgb),.4);
    -webkit-box-shadow: 0 0 0 14px rgba(var(--bcgr-rgb),.2);
    box-shadow: 0 0 0 14px rgba(var(--bcgr-rgb),.2)
}
...
.modal__payment-result .status-error {
    --bcgr-rgb: 247, 85, 85
}
...
#age-check .age-check-warning,.bump-countdown span {
    font-weight: 700
}
...
.home-location-select .tt-dropdown-menu,.modal-with-tabs .lightning-qr-code svg {
    width: 100%
}
...
.modal .ajax-form-loading>.loading-indicator {
    top: auto;
    bottom: 2em
}
...
.payment-option-details,.payment-submit-section {
    height: 0;
    overflow: hidden;
...
.radio.radio--custom .radio-listing-info {
    min-width: 0
}

.radio.radio--custom h4 {
    white-space: nowrap;
    overflow: hidden;
    text-overflow: ellipsis
}
...
.block--goto-spots .btn-success {
    background: #5cb85c -webkit-gradient(linear,left top,left bottom,from(#029147),to(#419641)) repeat-x;
    background: #5cb85c linear-gradient(#029147,#419641) repeat-x
}

.block--goto-spots .btn-success:hover {
    -webkit-box-shadow: 0 5px 15px rgba(0,0,0,.05),0 4px 10px rgba(33,37,41,.25);
    box-shadow: 0 5px 15px rgba(0,0,0,.05),0 4px 10px rgba(33,37,41,.25)
}
...
.block__coinvert {
    ...
    background-image: url(https://mrassets.cc/assets/bg/bcgr_coinvert_btn-a8cbf16596af34749db5d4ce9daf9358ab37416c168f0be7f38ea63ef95d5757.svg);
    background-size: cover;
    background-position: center;
    background-repeat: no-repeat;
...
.block__local-payments ul {
    -webkit-padding-start: 0;
    padding-inline-start:0;list-style: none
}

.block__local-payments ul li {
    width: auto;
    display: inherit
}

.block__local-payments label:has(input[type=radio]) {
    border: 1px solid #999;
    -webkit-transition: border-color .25s ease,background-color .25s ease,opacity .25s ease,-webkit-transform .25s ease,-webkit-box-shadow .25s ease;
    transition: transform .25s ease,box-shadow .25s ease,border-color .25s ease,background-color .25s ease,opacity .25s ease;
    transition: transform .25s ease,box-shadow .25s ease,border-color .25s ease,background-color .25s ease,opacity .25s ease,-webkit-transform .25s ease,-webkit-box-shadow .25s ease
}

.block__local-payments label:has(input[type=radio]):has(input:checked),.block__local-payments label:has(input[type=radio]):hover {
    background-color: #000;
    -webkit-box-shadow: 0 .46875rem 2.1875rem rgba(0,0,0,.3),0 .9375rem 1.40625rem rgba(19,21,22,.2),0 .25rem .53125rem rgba(49,52,57,.15),0 .125rem .1875rem rgba(62,66,72,.1);
    box-shadow: 0 .46875rem 2.1875rem rgba(0,0,0,.3),0 .9375rem 1.40625rem rgba(19,21,22,.2),0 .25rem .53125rem rgba(49,52,57,.15),0 .125rem .1875rem rgba(62,66,72,.1)
}

.block__local-payments label:has(input[type=radio]):hover {
    border-color: #e6e5e5
}

.block__local-payments label:has(input[type=radio]):has(input:checked) {
    -webkit-transform: scale(1.05);
    transform: scale(1.05);
    border-color: #c9910a
}

.block__local-payments label:has(input[type=radio]).unavailable {
    opacity: .3;
    pointer-events: none
}

.block__local-payments select {
    -webkit-appearance: none;
    -moz-appearance: none;
    appearance: none;
    border: 0;
...
.block__local-payments select:focus {
    border-color: #80bdff;
    outline: 0;
...
.video_capture .modal button.close {
    border: 0;
    text-shadow: none;
    color: #fff
}

.video_capture .modal-dialog {
    height: 85vh;
    overflow: hidden
}
...
.video_capture .modal-dialog::after {
...
.video_capture .modal-body {
    height: 100%;
    overflow: hidden
}

.video_capture .obscure .modal-dialog::after {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex
}
...
.popular-locations::before {
    ...
    height: 100%;
    opacity: .1;
    background-image: url(https://mrassets.cc/assets/layout/ladies-ab9531b2a9262803a6c9af3bb9d8fe95d151576e741dd3e4f10c37622a40dd69.svg);
    background-repeat: no-repeat;
...
.bump-form .bump-delay-info {
    background-color: #000
}

.bump-form .bump-delay-info i.fa-exclamation-triangle {
    font-size: .8rem
}
...
.drag-drop {
    ...
    padding: 30px 20px;
    background-color: #fff;
    -webkit-transition: border-color .3s,background-color .3s,-webkit-transform .2s;
    transition: transform .2s,border-color .3s,background-color .3s;
    transition: transform .2s,border-color .3s,background-color .3s,-webkit-transform .2s;
    cursor: pointer;
...
.drag-drop.drag-over .icon-image {
    background-color: transparent
}

.drag-drop.drag-drop-disabled {
    cursor: not-allowed
}

.drag-drop.drag-drop-disabled .upload-available {
    display: none
}

.drag-drop.drag-drop-disabled .upload-disabled {
    display: block
}
...
.modal-with-tabs .nav-tabs>li>a {
    font-size: clamp(.8rem,calc(.8rem + 1vw),1.2rem);
    height: 100%;
    line-height: 1.2
}
...
.modal-with-tabs .nav-tabs>li.active>a,.modal-with-tabs .nav-tabs>li.active>a:focus,.modal-with-tabs .nav-tabs>li.active>a:hover {
    border-color: rgba(255,255,255,.3);
    border-bottom-color: transparent
}

.modal-with-tabs label.selected,.modal-with-tabs label:hover {
    background: 0 0
}

.modal-with-tabs .form--comments p.comment {
    line-height: 1.3;
    font-size: .9em;
    color: rgba(255,255,255,.7)
}

.modal-with-tabs .lightning-qr-code {
    background: #fff;
    line-height: 0;
    border: 15px #fff solid
}
...
.msie.pbLoading .pbWrapper {
    background: url(https://mrassets.cc/assets/photobox-loading-9f7044d0102e3bfd9c328a230b573f41fc2aec61fd626c3532b3d00c485b2056.gif) no-repeat center center
}
...
.thredded--button:focus,.thredded--form--submit:focus {
    -webkit-box-shadow: 0 0 3px #f4b827;
    box-shadow: 0 0 3px #f4b827;
    outline: 0
}
...
.thredded--form :focus[type=color],.thredded--form :focus[type=date],.thredded--form :focus[type=datetime-local],.thredded--form :focus[type=datetime],.thredded--form :focus[type=email],.thredded--form :focus[type=month],.thredded--form :focus[type=number],.thredded--form :focus[type=password],.thredded--form :focus[type=search],.thredded--form :focus[type=tel],.thredded--form :focus[type=text],.thredded--form :focus[type=time],.thredded--form :focus[type=url],.thredded--form :focus[type=week],.thredded--form input:focus:not([type]),.thredded--form select:focus[multiple=multiple],.thredded--form textarea:focus {
    border-color: #f4b827;
    -webkit-box-shadow: inset 0 1px 3px rgba(0,0,0,.06),0 0 3px #f4b827;
    box-shadow: inset 0 1px 3px rgba(0,0,0,.06),0 0 3px #f4b827;
    outline: 0
}
...
ul.thredded--textcomplete-dropdown {
    ...
    border-color: #f4b827;
    border-top: 1px solid rgba(255,255,255,.1);
    -webkit-box-shadow: 0 1px 1px #f4b827;
    box-shadow: 0 1px 1px #f4b827;
    font-family: inherit;
    font-size: 1rem;
    line-height: 1.5;
    background: rgba(0,0,0,.2);
...
aside.onebox.amazon .source>a::before {
    background-image: url(https://mrassets.cc/assets/favicons/amazon-882adb9da23d489f1d53ba95c6ea4052536732d9caa57ec82a8f8d0f508e48ea.png);
...
aside.onebox.githubblob .source>a::before,aside.onebox.githubcommit .source>a::before,aside.onebox.githubgist .source>a::before,aside.onebox.githubissue .source>a::before,aside.onebox.githubpullrequest .source>a::before {
    background-image: url(https://mrassets.cc/assets/favicons/github-399dde69546053c9b4b248be54bf45f0a16bbc690b05380fb0973c0208a9dbdb.png);
    -webkit-filter: invert(100%);
    filter: invert(100%)
}

aside.onebox.googledocs .source>a::before {
    background-image: url(https://mrassets.cc/assets/favicons/google_branding/logo_drive_48px-e948128dd44239202c5cf5033dcdaa6e9dc637c8c9fac3c6a7c3e6ed03f53d9d.png)
}

aside.onebox.stackexchange .source>a::before {
    background-image: url(https://mrassets.cc/assets/favicons/stackexchange-9e9f17242c6d44137d40a3e55c71129060b103bfa31b7fead4ca3f18358da29f.png)
}

aside.onebox.twitterstatus .source>a::before {
    background-image: url(https://mrassets.cc/assets/favicons/twitter-4ff0f6e16c5f53ddd3b51eeeff8610ea0432d8ebafce89785d75c231386f80d7.png)
}

aside.onebox.wikipedia .source>a::before {
    background-image: url(https://mrassets.cc/assets/favicons/wikipedia-8feddaf7544a35c824f2e4274227fe8e7e7af71ddfe26523fe5fe20497cf5799.png);
    -webkit-filter: invert(100%);
    filter: invert(100%)
}
...
.googledocs-onebox-logo.g-docs-logo {
    background: url(https://mrassets.cc/assets/favicons/google_branding/logo_docs_48px-fb0c868b2a2e570a37726dfa8e91eda673bf34c4bdb4c867e4e4607ce4bfb04b.png) no-repeat
}

.googledocs-onebox-logo.g-forms-logo {
    background: url(https://mrassets.cc/assets/favicons/google_branding/logo_forms_48px-a89b95f68150f83307fd3b31173bdacbdb492320d0a05a99b6ebcf985bdc6a56.png) no-repeat
}

.googledocs-onebox-logo.g-sheets-logo {
    background: url(https://mrassets.cc/assets/favicons/google_branding/logo_sheets_48px-052ea7c8810fa9962ca4f9f43cf9d6ddfedbd95e808a7d10a5dc1bcd603db7c1.png) no-repeat
}

.googledocs-onebox-logo.g-slides-logo {
    background: url(https://mrassets.cc/assets/favicons/google_branding/logo_slides_48px-0c1b96992b26f2bf03b3da2a9575936c05e9df3bcbee4971e93fd6a6aa7a61ba.png) no-repeat
}

.googledocs-onebox-logo.g-calendar-logo {
    background: url(https://mrassets.cc/images/favicons/google_branding/logo_calendar_48px.png) no-repeat
}

.googledocs-onebox-logo.g-drive-logo {
    background: url(https://mrassets.cc/assets/favicons/google_branding/logo_drive_48px-e948128dd44239202c5cf5033dcdaa6e9dc637c8c9fac3c6a7c3e6ed03f53d9d.png) no-repeat
}
...
.gdocs-onebox-splash .gdocs-onebox-logo.g-calendar-logo {
    background: url(https://mrassets.cc/assets/favicons/google_branding/logo_calendar_128px-14289b045357cf5ef405d4dd271180c12b4eb5627a5016de8b226a99a77f8ecc.png) no-repeat
}
...
.custom-select2-dropdown::-webkit-scrollbar {
    width: 8px;
}

.custom-select2-dropdown::-webkit-scrollbar-track {
    background: #f1f1f1;
    border-radius: 4px;
}

.custom-select2-dropdown::-webkit-scrollbar-thumb {
    background: #ccc;
    border-radius: 4px;
}

.custom-select2-dropdown::-webkit-scrollbar-thumb:hover {
    background: #999;
}

.lead.phone-number a:hover, .lead.phone-number a:focus, .lead.phone-number a:active
 {
    text-decoration: auto !important;
}

#listing-price .fa-arrow-circle-down{
    margin-top: 10px;
    -webkit-transform: rotate(308deg);
    transform: rotate(308deg);
}
 #listing-price .fa-arrow-circle-up {
    margin-top: 10px;
...
#revsAndQs .no-reviews,
#revsAndQs #listing-questions p,
#revsAndQs #twitterPosts p {
font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif !important;
    font-size: 12px;
    color: #999;
    font-weight: 400;
...
<div class="profile-details-page">
  ...
  <div class="container-fluid">
   ...
   href="https://wa.me/{{$user->country_code}}{{ str_replace(' ', '', $user->phone) }}?text=Hi, I found your profile on MassageRepublic: {{ url()->current() }}"
   title="WhatsApp" 
   target="_blank"
   onclick="handleWhatsAppClick(event, this)">
                  ...
                  <a class="icon-telegram phone-icon" data-toggle="tooltip"
                    href="https://t.me/{{$user->country_code}}{{ str_replace(' ', '', $user->phone) }}" title="Telegram" target="_blank">
                  </a>
                  @endif

                  @if($user->issignal)
                  <a class="icon-signal phone-icon" data-toggle="tooltip"
                    href="https://signal.me/#p/+{{$user->country_code}}{{ str_replace(' ', '', $user->phone) }}" title=""
                  ...
                  @endif
                  <span>
                    <a class="tel" href="tel:+{{$user->country_code.$user->phone}}">+{{$user->country_code}} {{$user->phone}}</a>
                  </span>
                </span>
              </li>
            </ul>
