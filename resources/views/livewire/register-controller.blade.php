...
@media (max-width: 768px){
  body:has(.ev-register-page) .ev-header{display:none!important}
  ...
  .hidden-xs-reg{display:block!important}
}
...
@media(max-width:768px){
  ...
  .ev-register-divider{font-size:13px;color:#666}
  .ev-register-divider::before,.ev-register-divider::after{background:#222}
  .ev-register-divider span{font-size:13px;color:#666}
