                  ...
                  <div class="ev-mobile-contact" style="display:none;">
                    ...
                    <div class="ev-mc-group">
                        ...
                        <div style="display:flex;gap:8px;flex-wrap:wrap;">
                            ...
                            <label class="ev-msg-pill">
                                <input wire:model='iswechat' type="checkbox" value="1" @if($user->iswechat == 1) checked @endif style="display:none;">
                            ...
                            <label class="ev-msg-pill">
                                ...
                                <svg class="ev-msg-pill__icon" width="16" height="16" viewBox="0 0 24 24" fill="#3A76F0" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path d="M9.12.35a.4.4 0 0 1 .29.484l-.286 1.14a9.85 9.85 0 0 0-2.583 1.07l-.604-1.005a.4.4 0 1 1 .686-.411l.5.83a10.7 10.7 0 0 1 2.014-.835l.235-.937a.4.4 0 0 1 .483-.291zm6.05.292.236.936a10.7 10.7 0 0 1 2.012.834l.5-.83a.4.4 0 1 1 .686.411l-.604 1.006a9.85 9.85 0 0 0-2.581-1.07l-.286-1.14A.4.4 0 1 1 15.17.642zM12 1.5a10.5 10.5 0 0 0-3.027.443l.298 1.187a.4.4 0 0 1-.776.196L8.197 2.139A9.85 9.85 0 0 0 5.86 3.31l.687 1.144a.4.4 0 1 1-.686.412L5.175 3.72A9.9 9.9 0 0 0 3.722 5.17l1.142.686a.4.4 0 1 1-.412.686l-1.144-.687A9.85 9.85 0 0 0 2.137 8.19l1.189.297a.4.4 0 0 1-.196.776l-1.187-.297A10.5 10.5 0 0 0 1.5 12c0 1.034.149 2.034.443 2.974l1.187-.297a.4.4 0 0 1 .196.776l-1.189.297a9.85 9.85 0 0 0 1.171 2.336l1.144-.686a.4.4 0 1 1 .412.686l-1.142.686a9.9 9.9 0 0 0 1.452 1.452l.687-1.144a.4.4 0 0 1 .686.412L5.86 20.69a9.85 9.85 0 0 0 2.336 1.171l.297-1.189a.4.4 0 0 1 .777.196l-.297 1.189A10.5 10.5 0 0 0 12 22.5a10.5 10.5 0 0 0 3.027-.443l-.298-1.187a.4.4 0 0 1 .776-.196l.298 1.189a9.85 9.85 0 0 0 2.336-1.171l-.687-1.144a.4.4 0 1 1 .686-.412l.686 1.144a9.85 9.85 0 0 0 1.452-1.452l-1.144-.686a.4.4 0 1 1 .412-.686l1.144.686a9.85 9.85 0 0 0 1.171-2.336l-1.189-.297a.4.4 0 0 1 .196-.776l1.187.297c.294-.94.443-1.94.443-2.974s-.149-2.034-.443-2.974l-1.187.297a.4.4 0 0 1-.196-.776l1.189-.297A9.85 9.85 0 0 0 20.69 5.86l-1.144.687a.4.4 0 1 1-.412-.686l1.142-.686a9.9 9.9 0 0 0-1.452-1.452l-.686 1.144a.4.4 0 1 1-.686-.412L18.825 3.31a9.85 9.85 0 0 0-2.336-1.171l-.297 1.189a.4.4 0 1 1-.777-.196l.298-1.187A10.5 10.5 0 0 0 12 1.5z"/>
                                </svg>
                                <span>Signal</span>
                            </label>
                        </div>
