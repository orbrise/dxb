...
<div class="row page-title clearfix">
    <div class="page-title-left">
        ...
        <p class="mr-0 text-muted d-none d-md-inline-block">Update the category name</p>
    </div>
...
<div class="container-fluid px-0">
    <div class="lst-form-card">
        <div class="lst-form-head">
            <span class="lst-title-icon"><i class="fas fa-pen"></i></span>
            <h5>
                Edit Category
                <small>Update category <strong>#{{ $listing->id }}</strong></small>
            </h5>
        </div>
        <div class="lst-form-body">
            <form action="{{ route('admin.listings.update', $listing) }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ $listing->name }}" required autofocus>
                    @error('name')
