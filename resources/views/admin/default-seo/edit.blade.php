...
<div class="row page-title clearfix">
    <div class="page-title-left">
        <h5 class="mr-0 mr-r-5">Edit Default SEO Setting</h5>
        <p class="mr-0 text-muted d-none d-md-inline-block">Update default SEO fallback setting: {{ $defaultSeoSetting->name }}</p>
    </div>
    <!-- /.page-title-left -->
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-header">
                <h5 class="card-title mb-0 float-left">Edit Default SEO Setting: {{ $defaultSeoSetting->name }}</h5>
                ...
                <form action="{{ route('default-seo.update', $defaultSeoSetting->id) }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                                       value="{{ old('name', $defaultSeoSetting->name) }}" placeholder="e.g., global, escorts, homepage"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="priority" id="priority" class="form-control @error('priority') is-invalid @enderror" 
                                       value="{{ old('priority', $defaultSeoSetting->priority) }}" min="0" max="100">
                                @error('priority')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="is_active" id="is_active" class="form-control @error('is_active') is-invalid @enderror">
                                    <option value="1" {{ old('is_active', $defaultSeoSetting->is_active) == '1' ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ old('is_active', $defaultSeoSetting->is_active) == '0' ? 'selected' : '' }}>Inactive</option>
                                </select>
                                @error('is_active')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" 
                               value="{{ old('title', $defaultSeoSetting->title) }}" placeholder="Default page title">
                        @error('title')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" rows="3" class="form-control @error('description') is-invalid @enderror" 
                                  placeholder="Default meta description">{{ old('description', $defaultSeoSetting->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keywords" id="keywords" class="form-control @error('keywords') is-invalid @enderror" 
                               value="{{ old('keywords', $defaultSeoSetting->keywords) }}" placeholder="keyword1, keyword2, keyword3">
                        @error('keywords')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" id="content" rows="5" class="form-control @error('content') is-invalid @enderror" 
                                  placeholder="Additional content for SEO purposes (optional)">{{ old('content', $defaultSeoSetting->content) }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-save"></i> Update Default SEO Setting
                        </button>
...
$(document).ready(function() {
    // Initialize Summernote WYSIWYG editor for content
    $('#content').summernote({
        height: 300,
