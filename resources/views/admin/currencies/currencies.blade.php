                                            ...
                                            <tbody>
                                                ...
                                                <tr id="row{{$currency->id}}">
                                                    ...
                                                    <td><button type="button" key="{{$k}}" id="editthis" class="btn btn-info btn-sm"><i class="fa-solid fa-pen"></i> Edit</button> 
                                                    	<button type="button" key="{{$k}}" rid="{{$currency->id}}" id="updatethis" class="btn btn-success btn-sm"><i class="fa-solid fa-floppy-disk"></i> Update</button>

                                                    	<button onclick="return confirm('are you sure?')" type="button" id="del" key="{{$k}}" rid="{{$currency->id}}" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can"></i> Delete</button>
