                    ...
                    <tbody>
                        ...
                        <tr id="row{{$language->id}}">
                            ...
                            <td>
                                ...
                                <button type="button" key="{{$k}}" rid="{{$language->id}}" id="updatethis" class="btn btn-success btn-sm"><i class="fa-solid fa-floppy-disk"></i> Update</button>
                                <button onclick="return confirm('Are you sure?')" type="button" id="del" key="{{$k}}" rid="{{$language->id}}" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can"></i> Delete</button>
