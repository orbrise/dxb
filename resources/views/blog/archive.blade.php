...
@section('title', 'Archive: ' . $title . ' - Blog')
@section('meta_description', 'Blog posts from ' . $title)

@section('content')
<div class="date-outer" style="margin-bottom: 20px;">
    <h1 style="font-size: 1.5em; margin-bottom: 10px;">Archive: {{ $title }}</h1>
                    ...
                    <article class="post">
                        ...
                        <div class="post-footer">
                            <div class="post-meta-info">
                                @if($post->category)
                                    <span>
                                        <a href="{{ route('blog.category', $post->category->slug) }}" class="category-link">{{ $post->category->name }}</a>
                                    </span>
                                @endif
                                @if($post->author)
    ...
    @empty
        <div class="date-outer">
            <div class="post-body" style="text-align: center; padding: 40px 20px;">
                <p style="font-size: 1.2em;">No articles found for this period.</p>
