...
@section('meta_description', $category->meta_description ?: 'Articles in ' . $category->name . ' category')

@section('content')
<div class="date-outer" style="margin-bottom: 20px;">
    <h1 style="font-size: 1.5em; margin-bottom: 10px;">{{ $category->name }}</h1>
    @if($category->description)
        <p style="color: #999;">{{ $category->description }}</p>
    @endif
    ...
    @empty
        <div class="date-outer">
            <div class="post-body" style="text-align: center; padding: 40px 20px;">
                <p style="font-size: 1.2em;">No articles in this category yet.</p>
            </div>
        </div>
    @endforelse
</div>
