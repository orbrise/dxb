            ...
            <div class="date-posts">
                <div class="post-outer">
                    <article class="post">
                        ...
                        <div class="post-body">
                            @php
                                $words = str_word_count(strip_tags($post->content), 2);
                        ...
                        <div class="post-footer">
                            <div class="post-meta-info">
                                ...
                                <span class="post-timestamp">
                                    at <a href="{{ route('blog.show', $post->slug) }}">{{ $post->published_at->format('H:i') }}</a>
                                </span>
                                @if($post->category)
                                    <span>
                                ...
                                <span class="share-icons" style="margin-top: 0;">
    ...
    @empty
        <div class="date-outer">
            <div class="post-body" style="text-align: center; padding: 40px 20px;">
                <p style="font-size: 1.2em;">No articles yet. Check back soon!</p>
            </div>
        </div>
    @endforelse
</div>
